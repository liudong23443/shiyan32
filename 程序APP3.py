        ...
        with st.spinner("计算预测结果..."):
            try:
                ...
                fig = go.Figure(go.Indicator(
                    ...
                    domain = {'x': [0, 1], 'y': [0, 1]},
                    title = {'text': "三年内死亡风险", 'font': {'size': 16, 'family': 'SimHei', 'color': 'black', 'weight': 'bold'}},
                    gauge = {
                        'axis': {'range': [0, 100], 'tickwidth': 1, 'tickcolor': "darkblue", 'tickfont': {'color': 'black', 'size': 10}},
                        'bar': {'color': "darkblue"},
                        'bgcolor': "white",
                        'borderwidth': 1,
                        'bordercolor': "gray",
                ...
                fig.update_layout(
                    ...
                    paper_bgcolor="white",
                    plot_bgcolor="white",
                    font={'family': "SimHei", 'color': 'black', 'size': 12},
                )
                ...
                <div style="text-align: center; margin-top: -0.5rem; margin-bottom: 0.5rem;">
                    <span style="font-size: 1.2rem; font-family: 'SimHei'; color: {risk_color}; font-weight: bold;">
                        {risk_category}
                    </span>
                </div>
                """, unsafe_allow_html=True)
                ...
                try:
                    with st.spinner("正在生成SHAP解释图..."):
                        ...
                        # 使用waterfall图，这是最新版本推荐的可视化方式 - 进一步减小尺寸
                        plt.figure(figsize=(7, 3.5), dpi=250, facecolor='white')  # 进一步减小图表尺寸
                        ...
                        # 保存并显示图
                        plt.savefig("shap_waterfall_plot.png", bbox_inches='tight', dpi=250, transparent=False)
                        plt.close()
                        st.image("shap_waterfall_plot.png")
                        
                        # 添加简要解释 - 更紧凑
                        st.markdown("""
                        <div style="background-color: #f8f9fa; padding: 5px; border-radius: 3px; margin-top: 5px; font-size: 0.8rem;">
